...
# Manage Docker as a non-root users
# sudo groupadd docker
# sudo usermod -aG docker $USER
# newgrp docker
# https://github.com/eleidan/docker-bot/blob/master/src/bot
...
# wget https://raw.githubusercontent.com/eleidan/docker-bot/master/src/bot
